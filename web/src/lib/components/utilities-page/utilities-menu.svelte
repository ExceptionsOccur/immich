<script lang="ts">
  ...
  import { mdiContentDuplicate, mdiImageSizeSelectLarge, mdiMapMarkerMultipleOutline } from '@mdi/js';
...
<div class="border border-gray-300 dark:border-immich-dark-gray rounded-3xl pt-1 pb-6 dark:text-white">
  ...
  <a
    href={AppRoute.GEOLOCATION_MANAGE}
    class="w-full hover:bg-gray-100 dark:hover:bg-immich-dark-gray flex items-center gap-4 p-4"
  >
    <span
      ><Icon path={mdiMapMarkerMultipleOutline} class="text-immich-primary dark:text-immich-dark-primary" size="24" />
    </span>
    <!-- {$t('review_duplicates')} -->
    地理位置信息管理
  </a>
